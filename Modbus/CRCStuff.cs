...
namespace MyPLC.Modbus
{
    public static class CRCStuff
    {
        ...
        public static byte[] calculateCRC(byte[] messageArray, int dataLength)
        {
            byte usCRCHi = 0xFF;
            byte usCRCLo = 0xFF;
        ...
        public static bool checkCRC(byte[] messageToCheck, int numberOfBytes)
        {
            byte[] calculatedCRC;
